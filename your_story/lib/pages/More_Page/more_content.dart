    ...
    child: Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          const SizedBox(height: 8),
          const Text(
            'أخبرنا إذا كان لديك استفسارات أو أسئلة',
    ...
    child: Container(
      ...
      child: const Column(
        ...
        children: <Widget>[
          ...
          Text(
              'إن دخول المستخدم إلى التطبيق واستخدامه يعتبر إقرارًا منه بالموافقة على شروط الاستخدام، كما يوافق على الالتزام بكل مما يلي:'),
          Text(
