              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    child:const Center(
                        child: Text(" الدخول الى الحساب", style: TextStyle( color: Color.fromRGBO(49, 39, 79, 1),
                    ...
                    FadeInUp(duration: const Duration(milliseconds: 1700), child: Container(
                      decoration: BoxDecoration(
                        ...
                        color: Colors.white,
                        border: Border.all(color: const Color.fromARGB(75, 135, 145, 198)),
                        boxShadow: const [
                          BoxShadow(
                    ...
                    child: const Text("نسيت كلمة المرور؟", style: TextStyle(color: Color.fromRGBO(73, 68, 124, 1)),
                          )
                        )
                       )
                      ),
                            ...
                            try {
                              ...
                              print("pass/email is wrong");
                               ScaffoldMessenger.of(context).showSnackBar(
                                          CustomSnackBar(
                                 content: "البريد او كلمة المرور غير صحيح/ة",
                                 ),
                                );                           
                            }
                          }
